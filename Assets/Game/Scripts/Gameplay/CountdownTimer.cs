...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class CountdownTimer : MonoBehaviourPunCallbacks
    {
        ...
        public static float Countdown = 25.0f;
        ...
        public delegate void CountdownTimerHasUpdated(double sec);
        public static event CountdownTimerHasUpdated OnCountdownTimerHasUpdated;
        public void Start()
        {
            if (this.Text == null)
            {
        ...
        public void Update()
        {
            ...
            if (OnCountdownTimerHasUpdated != null)
            {
               
                OnCountdownTimerHasUpdated(countdown);
        ...
        public static void StartTimer(float _newtime)
        {
