...
namespace UnityEngine.UI
{
        ...
        ICanvasElement
    {
        ...
        [SerializeField]
        private Color m_SelectionColor = new Color(168f / 255f, 206f / 255f, 255f / 255f, 192f / 255f);//192f / 255f
        ...
        private void AssignPositioningIfNeeded()
        {
            ...
            {
                //caretRectTrans.localPosition = m_TextComponent.rectTransform.localPosition;
                caretRectTrans.localPosition = new Vector3(m_TextComponent.rectTransform.localPosition.x, m_TextComponent.rectTransform.localPosition.y-30f, m_TextComponent.rectTransform.localPosition.z);
                caretRectTrans.localRotation = m_TextComponent.rectTransform.localRotation;
                caretRectTrans.localScale = m_TextComponent.rectTransform.localScale;
                //caretRectTrans.anchorMin = m_TextComponent.rectTransform.anchorMin;
                caretRectTrans.anchorMin = new Vector2(0.5f,0.5f);
                //caretRectTrans.anchorMax = m_TextComponent.rectTransform.anchorMax;
                caretRectTrans.anchorMax = new Vector2(0.5f, 0.5f);
                //caretRectTrans.anchoredPosition = m_TextComponent.rectTransform.anchoredPosition;
                caretRectTrans.anchoredPosition = new Vector2(m_TextComponent.rectTransform.anchoredPosition.x, m_TextComponent.rectTransform.anchoredPosition.y-30f);
                caretRectTrans.sizeDelta = m_TextComponent.rectTransform.sizeDelta;
                caretRectTrans.pivot = m_TextComponent.rectTransform.pivot;
                //Debug.Log(caretRectTrans.localPosition + " " + caretRectTrans.sizeDelta + " " + caretRectTrans.anchorMax + " "+caretRectTrans.anchoredPosition);
            }
        }
